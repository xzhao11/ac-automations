...
async def buy_fruit(controller_state: ControllerState):
    """
    Example controller script.
    Navigates to the "Test Controller Buttons" menu and presses all buttons.
    """
    ...
    user_input = asyncio.ensure_future(
        ainput(prompt='Buying fruits... Press <enter> to stop.')
    )
...
async def _main(args):
    ...
    with utils.get_output(path=args.log, default=None) as capture_file:
        ...
        async def _make_fish_food():
            """
            test_buttons - Navigates to the "Test Controller Buttons" menu and presses all buttons.
            """
            await make_fish_food(controller_state)

        # add the script from above
        cli.add_command('fish', _make_fish_food)

        async def _buy_fruit():
            """
            test_buttons - Navigates to the "Test Controller Buttons" menu and presses all buttons.
            """
            await buy_fruit(controller_state)

        # add the script from above
        cli.add_command('buy', _buy_fruit)
